(function( $ ) {
  var flip = function($dom, callback) {
    ...
    var backHeight = $dom.data("backHeight");
    $dom.find($dom.data("back")).css({
      "height": backHeight + "px"
    });
    $dom.find($dom.data("back")).parent().css({
      "height" : backHeight + "px"
    })
  ...
  var unflip = function($dom, callback) {
    ...
    var frontHeight = $dom.data("frontHeight");
    $dom.find($dom.data("front")).css({
      "height": frontHeight + "px"
    });
    $dom.find($dom.data("front")).parent().css({
      "height" : frontHeight + "px"
    })
    ...
    this.each(function(){
      var $dom = $(this);
        ...
        if (options !== undefined && (typeof(options) == "boolean" || typeof(options) == "string")) { // Force flip the DOM
          ...
          $dom.data("backHeight", settings.backHeight);
          $dom.data("frontHeight", settings.frontHeight);
          ...
          if (settings.frontHeight) { faces.css({'height': settings.frontHeight + 'px'}); $dom.find(settings.front).parent().css({'height': settings.frontHeight + 'px'}) };
          faces.css({
