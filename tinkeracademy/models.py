...
class TinkerAcademyUser(db.Model):
	...
	hw1 = db.StringProperty()
	hw2 = db.StringProperty()
	hw3 = db.StringProperty()
	hw4 = db.StringProperty()
	hw5 = db.StringProperty()
	hw6 = db.StringProperty()
	hw7 = db.StringProperty()
	hw8 = db.StringProperty()
	hw1results = db.IntegerProperty()
	hw2results = db.IntegerProperty()
	hw3results = db.IntegerProperty()
	hw4results = db.IntegerProperty()
	hw5results = db.IntegerProperty()
	hw6results = db.IntegerProperty()
	hw7results = db.IntegerProperty()
	hw8results = db.IntegerProperty()
